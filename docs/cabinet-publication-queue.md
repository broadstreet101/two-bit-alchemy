...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Charlie Adlard Amish Zombie Sketch | `content/workbench/cabinet/walking-dead-sketch.md` | Workbench Draft | Structured placeholder only | Not captured | Needed | Not prepared | Not prepared | Not prepared | Not started | Not ready | Future Cabinet shelf; exact shelf pending approval | Current file contains headings only. Do not publish until object details, story, source/provenance, photos, captions, alt text, metadata, and publication approval exist. |
